...
function defaultUnknownHandler(state, node) {
  ...
  const result = "value" in node && !(own5.call(data, "hProperties") || own5.call(data, "hChildren")) ? { type: "text", value: node.value } : {
    type: "element",
    tagName: "div",
    properties: {},
    children: state.all(node)
...
function omission(handlers2) {
  ...
  function omit(node, index2, parent) {
    return own7.call(handlers2, node.tagName) && handlers2[node.tagName](node, index2, parent);
  }
}
